...
* @version $Id: moneybookers_acc.php 6383 2012-08-27 16:53:06Z alatak $
* @package VirtueMart
* @subpackage payment
...
class plgVmpaymentMoneybookers_Acc extends plgVmpaymentMoneybookers
    {
    ...
    function plgVmConfirmedOrder($cart, $order, $payment_method = '')
        {
        parent::plgVmConfirmedOrder($cart, $order, "ACC");
        }
    }
// No closing tag