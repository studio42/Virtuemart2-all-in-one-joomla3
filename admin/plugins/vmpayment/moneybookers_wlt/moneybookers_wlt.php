...
* @version $Id: moneybookers_wlt.php 6383 2012-08-27 16:53:06Z alatak $
* @package VirtueMart
* @subpackage payment
...
class plgVmpaymentMoneybookers_Wlt extends plgVmpaymentMoneybookers
    {
    ...
    function plgVmConfirmedOrder($cart, $order, $payment_method = '')
        {
        parent::plgVmConfirmedOrder($cart, $order, "WLT");
        }
    }
// No closing tag