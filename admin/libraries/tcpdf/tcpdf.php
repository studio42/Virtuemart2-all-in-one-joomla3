...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		...
		while ($key < $maxel) {
			...
			if ($dom[$key]['tag']) {
				if ($dom[$key]['opening']) {
					...
					// table
					if (!isset($cellspacingx) ) $cellspacingx = 0;
					if (!isset($table_columns_width) ) $table_columns_width = 0 ;
					if (!isset($cellspacing ) ) $cellspacing = array('H' => 0, 'V' => 0);
	 ...
	 * @since 4.5.000 (2009-01-02)
	 */
	protected function _setBuffer($data) {
